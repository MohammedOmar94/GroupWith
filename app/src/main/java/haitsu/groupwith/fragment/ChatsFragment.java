...
import haitsu.groupwith.other.Adapters.ChatsAdapter;
import haitsu.groupwith.other.DBHandler;
...
public class ChatsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // SQLiteDatabase s = getActivity().openOrCreateDatabase("groupwith",MODE_PRIVATE,null);
        // db.onCreate(s);
